                 ...
                 void(Block0&, T1, Block1 const&, Block2 const&)>
{
  static bool const ct_valid = 
    ...
    dda::Data<Block0>::ct_cost == 0 &&
    dda::Data<Block1>::ct_cost == 0 &&
    dda::Data<Block2>::ct_cost == 0;
  ...
  static bool rt_valid(Block0& r, T1, Block1 const& a, Block2 const& b)
  {
    ...
    dda::Data<Block0> ext_r(const_cast<Block0&>(r));
    dda::Data<Block1> ext_a(const_cast<Block1&>(a));
    dda::Data<Block2> ext_b(const_cast<Block2&>(b));
  ...
  static void exec(Block0& r, T1 alpha, Block1 const& a, Block2 const& b)
  {
    ...
    if (is_same<order0_type, row2_type>::value)
    {
      impl::sal::mat_mul(a.size(1, 0), b.size(1, 0),
			 1,
			 ext_a.ptr(), ext_a.stride(0),
			 ext_b.ptr(), ext_b.stride(0),
			 ext_r.ptr(), ext_r.stride(0),
			 0);
    }
...
{
  static storage_format_type const complex0_format = get_block_layout<Block0>::storage_format;
  static storage_format_type const complex1_format = get_block_layout<Block1>::storage_format;
  static storage_format_type const complex2_format = get_block_layout<Block2>::storage_format;
  ...
  static bool const ct_valid = 
    ...
    complex0_type == complex1_type && complex1_type == complex2_type;
                 ...
                 T(Block0 const&, Block1 const&)>
{
  ...
  static bool const ct_valid = 
    ...
    complex1_format == complex2_format;
				 ...
				 expr::Unary<expr::op::Conj, Block2, true> const&)>
{
  ...
  static bool const ct_valid = 
    ...
    is_same<complex<T>, typename Block2::value_type>::value &&
    // check that direct access is supported
    dda::Data<Block1, dda::in>::ct_cost == 0 &&
    dda::Data<Block2, dda::in>::ct_cost == 0 &&
    // check complex layout is consistent
			 ...
			 expr::Unary<expr::op::Conj, Block2, true> const& b)
  {
    ...
    dda::Data<Block1, dda::in> data_a(a);
    dda::Data<Block2, dda::in> data_b(b.arg());
		 ...
		 typename enable_if_c<Block1::dim == 2 && Block2::dim == 1>::type>
{
  ...
  static bool const ct_valid = 
    ...
    dda::Data<Block2, dda::in>::ct_cost == 0 &&
    // check complex layout
    complex0_format == complex1_format && complex1_format == complex2_format;
  ...
  static bool rt_valid(Block0& r, Block1 const& a, Block2 const& b)
  {
    ...
    bool unit_minor_stride = 
      (data_a.stride(a_dim0) == data_a.size(a_dim1) * data_a.stride(a_dim1)) &&
      (data_r.stride(0) == 1) && 
      (data_b.stride(0) == 1);
		 ...
		 typename enable_if_c<Block1::dim == 1 && Block2::dim == 2>::type>
{
  ...
  static bool rt_valid(Block0& r, Block1 const& a, Block2 const& b)
  {
    ...
    bool unit_minor_stride = 
      (data_b.stride(b_dim0) == data_b.size(b_dim1) * data_b.stride(b_dim1)) &&
      (data_r.stride(0) == 1) && 
      (data_a.stride(0) == 1);
		 ...
		 typename enable_if_c<Block1::dim == 2 && Block2::dim == 2>::type>
{
  ...
  static bool rt_valid(Block0& r, Block1 const& a, Block2 const& b)
  {
    ...
    bool unit_minor_stride =
      (data_r.stride(r_dim1) == 1) &&
      (data_a.stride(a_dim1) == 1) &&
      (data_b.stride(b_dim1) == 1);
		 ...
		 typename enable_if_c<Block1::dim == 2 && Block2::dim == 1>::type>
{
  ...
  static bool rt_valid(Block0&, Block1 const& a, Block2 const&)
  {
    ...
    bool dense_major_dim = 
      (data_a.stride(a_dim0) == (stride_type)data_a.size(a_dim1) *
                                            data_a.stride(a_dim1));
		 ...
		 typename enable_if_c<Block1::dim == 1 && Block2::dim == 2>::type>
{
  ...
  static bool rt_valid(Block0&, Block1 const&, Block2 const& b)
  {
    ...
    bool dense_major_dim = 
      (data_b.stride(b_dim0) == (stride_type)data_b.size(b_dim1) *
					    data_b.stride(b_dim1));
		 ...
		 typename enable_if_c<Block1::dim == 2 && Block2::dim == 2>::type>
{
  ...
  static bool rt_valid(Block0& r, Block1 const& a, Block2 const& b)
  {
    ...
    bool dense_major_dim = 
      (data_r.stride(r_dim0) == (stride_type)data_r.size(r_dim1) *
                                            data_r.stride(r_dim1)) &&
      (data_a.stride(a_dim0) == (stride_type)data_a.size(a_dim1) *
                                            data_a.stride(a_dim1)) &&
      (data_b.stride(b_dim0) == (stride_type)data_b.size(b_dim1) *
                                            data_b.stride(b_dim1));
