	  ...
	  unsigned int      iter_max)
{
  ...
  {
    case overlay_vsub_f:
    case overlay_cvsub_f:
    {
      Binary_params *p = (Binary_params*)params;

      // words per point
      int wpp = p->cmd == overlay_vsub_f ? 1 : 2;
	   ...
	   unsigned int      n)
{
  ...
  switch (p->cmd)
  {
    ...
    case overlay_zvsub_f:
    {
      ...
      zvsub1_f(a_re, a_im, b_re, b_im, r_re, r_im, length);
    }
    break;
  }
