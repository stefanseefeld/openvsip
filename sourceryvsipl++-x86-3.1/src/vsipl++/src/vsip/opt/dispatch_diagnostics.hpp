...
{
  typedef dispatcher::Diagnostics<O, R(A)> diagnostics;
...
{
  typedef dispatcher::Diagnostics<O, R(A1, A2)> diagnostics;
  return diagnostics::diag(a1, a2);
}

template <typename O, typename R, typename A1, typename A2, typename A3>
void dispatch_diagnostics(A1 a1, A2 a2, A3 a3)
{
  typedef dispatcher::Diagnostics<O, R(A1, A2, A3)> diagnostics;
  return diagnostics::diag(a1, a2, a3);
}

template <typename O, typename R, typename A1, typename A2, typename A3, typename A4>
void dispatch_diagnostics(A1 a1, A2 a2, A3 a3, A4 a4)
{
  typedef dispatcher::Diagnostics<O, R(A1, A2, A3, A4)> diagnostics;
  return diagnostics::diag(a1, a2, a3, a4);
}

template <typename O, typename R, typename A1, typename A2, typename A3, typename A4, typename A5>
void dispatch_diagnostics(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5)
{
  typedef dispatcher::Diagnostics<O, R(A1, A2, A3, A4, A5)> diagnostics;
  return diagnostics::diag(a1, a2, a3, a4, a5);
}

template <typename O, typename R, typename A1, typename A2, typename A3, typename A4,
	  typename A5, typename A6>
void dispatch_diagnostics(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6)
{
  typedef dispatcher::Diagnostics<O, R(A1, A2, A3, A4, A5, A6)> diagnostics;
  return diagnostics::diag(a1, a2, a3, a4, a5, a6);
}
