...
/** @file    vsip/opt/signal/corr_ext.hpp
    ...
    @date    2005-10-05
    @brief   VSIPL++ Library: Correlation class implementation using dda::Data.
*/
...
VSIP_NOTHROW
{
  ...
  typedef typename get_block_layout<Block2>::type LP2;
  ...
  typedef dda::Data<Block0, dda::in, use_LP0> ref_ext_type;
  typedef dda::Data<Block1, dda::in, use_LP1> in_ext_type;
  typedef dda::Data<Block2, dda::out, use_LP2> out_ext_type;
