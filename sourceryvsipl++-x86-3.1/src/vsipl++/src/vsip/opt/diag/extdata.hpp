...
VSIP_IMPL_CLASS_NAME(choose_access::CA_Eq_cmplx_eq_order_dense_ok)
VSIP_IMPL_CLASS_NAME(choose_access::CA_Eq_cmplx_eq_order_aligned_ok)
...
VSIP_IMPL_CLASS_NAME(interleaved_complex)
VSIP_IMPL_CLASS_NAME(split_complex)
...
struct Diagnose_ext_data
{
  ...
  typedef typename get_block_layout<BlockT>::storage_format blk_storage_format;
  typedef typename LP::storage_format lp_storage_format;
  ...
  static void diag(std::string name)
  {
    ...
    cout << "diagnose_ext_ptr(" << name << ")" << endl
	 << "  BlockT: " << typeid(BlockT).name() << endl
	 << "  Block LP" << endl
	 << "    storage_format: " << Class_name<blk_storage_format>::name() << endl
	 << "  Req LP" << endl
	 << "    storage_format: " << Class_name<lp_storage_format>::name() << endl
...
template <typename BlockT,
	  dimension_type Dim = get_block_layout<BlockT>::dim>
struct Diagnose_rt_ext_data
{
  ...
  static void diag(std::string name)
  {
    ...
    cout << "diagnose_rt_ext_ptr(" << name << ")" << endl
	 << "  BlockT: " << typeid(BlockT).name() << endl
