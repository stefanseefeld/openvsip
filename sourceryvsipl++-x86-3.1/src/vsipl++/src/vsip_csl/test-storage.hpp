...
vsip::storage_format_type const default_storage_format = vsip::impl::dense_complex_format;

template <vsip::dimension_type Dim,
	  typename             T,
	  typename             Order      = typename Default_order<Dim>::type,
          typename             MapT       = vsip::Local_map,
	  vsip::storage_format_type C = default_storage_format>
class Storage;
...
{
  typedef vsip::Layout<Dim, Order, vsip::dense, C> LP;
  typedef vsip::impl::Strided<Dim, T, LP, MapT>       type;
};
...
template <vsip::dimension_type Dim,
	  ...
	  typename             Order,
          typename             MapT>
struct Storage_block<Dim, T, Order, MapT, default_storage_format>
{
