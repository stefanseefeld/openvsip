...
private:
  ...
  class Ser_expr_holder : public Holder
  {
    ...
    typedef typename impl::view_of<LHS>::type lhs_view_type;
    typedef typename impl::view_of<RHS>::const_type rhs_view_type;
  ...
  struct Holder_factory<D, impl::assignment::par_expr>
  {
	...
	typedef typename impl::view_of<lhs_local_block_type>::type lhs_local_view_type;
	typedef typename impl::view_of<rhs_local_block_type>::type rhs_local_view_type;
