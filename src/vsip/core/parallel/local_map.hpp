...
public:
  ...
  processor_iterator processor_begin(index_type /*sb*/) const
    { VSIP_IMPL_THROW(impl::unimplemented("Local_map::processor_begin()")); }
  processor_iterator processor_end  (index_type /*sb*/) const
...
public:
  ...
  index_type impl_global_from_local_index(dimension_type /*d*/, index_type sb ATTRIBUTE_UNUSED,
				     index_type idx)
    const VSIP_NOTHROW
...
public:
  ...
  processor_type impl_proc_from_rank(index_type idx ATTRIBUTE_UNUSED) const
