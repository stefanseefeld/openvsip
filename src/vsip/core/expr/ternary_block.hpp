...
public:
  ...
  typedef typename impl::Ternary_map<Block1, Block2, Block3>::map_type map_type;
  ...
  { return impl::Ternary_map<Block1, Block2, Block3>::get(first_, second_, third_);}
...
struct get_block_layout<vsip_csl::expr::Ternary<O, A1, A2, A3> const>
  : get_block_layout<typename vsip_csl::expr::Ternary<O, A1, A2, A3>::cache_type> {};
...
void
assert_local(expr::Ternary<O, B1, B2, B3, E> const &, index_type)
{
}
