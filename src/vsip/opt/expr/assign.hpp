...
#  include <vsip/opt/mkl/assign.hpp>
#endif
...
struct Evaluator<op::assign<1>, be::copy, void(LHS &, RHS const &)>
{
  ...
  typedef typename 
  impl::adjust_layout_dim<1, typename get_block_layout<LHS>::type>::type
  lhs_layout_type;

  typedef typename 
  impl::adjust_layout_dim<1, typename get_block_layout<RHS>::type>::type
  rhs_layout_type;
  ...
  static void exec(LHS &lhs, RHS const &rhs)
  {
    dda::Data<LHS, dda::out, lhs_layout_type> ext_lhs(lhs);
    dda::Data<RHS, dda::in, rhs_layout_type> ext_rhs(rhs);

    typename dda::Data<LHS, dda::out, lhs_layout_type>::ptr_type ptr1 = ext_lhs.ptr();
    typename dda::Data<RHS, dda::in, rhs_layout_type>::ptr_type ptr2 = ext_rhs.ptr();
    ...
    if (is_same<typename LHS::value_type,
