...
#ifndef ovxx_vertex_hpp_
#define ovxx_vertex_hpp_
...
template <typename T>
inline bool 
operator==(Vertex<T, 1> const& i, Vertex<T, 1> const& j) VSIP_NOTHROW
{
...
template <typename T>
inline bool 
operator==(Vertex<T, 2> const& i, Vertex<T, 2> const& j) VSIP_NOTHROW
{
...
template <typename T>
inline bool 
operator==(Vertex<T, 3> const& i, Vertex<T, 3> const& j) VSIP_NOTHROW
{
