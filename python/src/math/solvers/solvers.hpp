...
void define_lud()
{
  ...
  bpl::class_<lud_type, boost::noncopyable>
...
void define_chold()
{
  ...
  bpl::class_<chold_type, boost::noncopyable>
...
void define_qrd()
{
  ...
  bpl::class_<qrd_type, boost::noncopyable>
...
{
  typedef svd<T> svd_type;
  bpl::class_<svd_type, boost::noncopyable>
