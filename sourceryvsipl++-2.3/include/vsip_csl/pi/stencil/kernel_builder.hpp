...
template <typename S, 
          ...
          typename T>
void build_kernel(Binary<expr::op::Mult, S, Binary<O, L, R> > e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
...
template <template <typename, typename> class O, typename L, typename R,
          typename S, typename T>
void build_kernel(Binary<expr::op::Div, Binary<O, L, R>, S> e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
  Kernel_builder<Binary<O, L, R>, T>::apply(e.arg1(), k1);
...
template <typename B, typename I, typename J,
          typename S, typename T>
void build_kernel(Binary<expr::op::Mult, Call<B, I, J>, S> e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
...
template <typename S, 
          ...
          typename T>
void build_kernel(Binary<expr::op::Mult, S, Call<B, I, J> > e,
                  Kernel<T>& k)
{
  Kernel<T> k1(k);
