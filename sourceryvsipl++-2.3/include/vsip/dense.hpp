...
typedef vsip::impl::Cmplx_split_fmt dense_complex_type;
#else
typedef vsip::impl::Cmplx_inter_fmt dense_complex_type;
#endif
...
class Dense<1, T, O, M>
  : public impl::Strided<1, T, impl::Layout<1, O, 
      impl::Stride_unit_dense, impl::dense_complex_type>, M>
{
  typedef impl::Strided<1, T, 
    impl::Layout<1, O, 
      impl::Stride_unit_dense, impl::dense_complex_type>, M>
   	  base_type;
  enum private_type {};
...
/// Partial specialization of Dense class template for 1,2-dimension.
  template <typename T, typename O, typename M>
class Dense<2, T, O, M>
  : public impl::Strided<2, T, impl::Layout<2, O, 
        impl::Stride_unit_dense, impl::dense_complex_type>, M>
{
  typedef impl::Strided<2, T, impl::Layout<2, O, 
      impl::Stride_unit_dense, impl::dense_complex_type>, M>
          base_type;
  enum private_type {};
  typedef typename impl::Complex_value_type<T, private_type>::type uT;
...
template <typename T, typename O, typename M>
class Dense<3, T, O, M>
  : public impl::Strided<3, T, impl::Layout<3, O, 
    impl::Stride_unit_dense, impl::dense_complex_type>, M>
{
  typedef impl::Strided<3, T, impl::Layout<3, O, 
      impl::Stride_unit_dense, impl::dense_complex_type>, M>
          base_type;
  enum private_type {};
  typedef typename impl::Complex_value_type<T, private_type>::type uT;
...
struct Block_layout<Dense<D, T, O, M> >
  : Block_layout<Strided<D, T,
      Layout<D, O, Stride_unit_dense, dense_complex_type>, M> >
{};
