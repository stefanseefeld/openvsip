                 ...
                 void(T&, Block const&, OrderT, impl::Int_type<Dim>)>
{
  ...
  {
    typedef typename impl::Proper_type_of<Block>::type block_type;
    impl::Ext_data_dist<block_type, impl::SYNC_IN> ext(blk);
    impl::cvsip::View_from_ext<Dim, value_type> view(ext);
    
    r = impl::cvsip::Reduce_class<ReduceT, Dim, value_type>::exec(view.view_.ptr());
  }
};
