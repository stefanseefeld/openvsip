...
template <typename T>
class Dense_storage<Cmplx_split_fmt, complex<T> >
{
public:
  ...
  vsip::complex<T> &ref(index_type)
  {
	...
	"Dense_storage<Cmplx_split_fmt>::ref - unimplemented"));
  }
  ...
  type data() { return type(real_data_, imag_data_);}
  const_type data() const { return const_type(real_data_, imag_data_);}
