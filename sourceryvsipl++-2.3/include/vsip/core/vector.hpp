...
#ifndef VSIP_IMPL_REF_IMPL
  template <int I>
  vsip_csl::pi::Call<block_type, vsip_csl::pi::Iterator<I> >
  operator()(vsip_csl::pi::Iterator<I> i)
  {
    using namespace vsip_csl::pi;
    return Call<block_type, Iterator<I> >(this->block(), i);
  }
#endif
...
public:
  ...
  template <int I>
  vsip_csl::pi::Call<block_type, vsip_csl::pi::Iterator<I> >
  operator()(vsip_csl::pi::Iterator<I> const &i)
  {
    using namespace vsip_csl::pi;
    return Call<block_type, Iterator<I> >(this->block(), i);
  }
