...
/// 1D real forward FFT
template <typename T>
class Fft_backend<1, T, std::complex<T>, 0>
...
/// 1D real inverse FFT
template <typename T>
class Fft_backend<1, std::complex<T>, T, 0>
  : public Backend<1, T, 0, 1>
{
public:
...
class Fft_backend<1, std::complex<T>, std::complex<T>, S>
...
/// 2D real forward FFT
template <typename T, int S>
class Fft_backend<2, T, std::complex<T>, S>
...
/// 2D real inverse FFT
template <typename T, int S>
class Fft_backend<2, std::complex<T>, T, S>
  : public Backend<2, T, S, 1>
{
public:
  typedef std::complex<T> input_value_type;
