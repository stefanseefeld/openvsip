...
struct Dispatcher_traits<serial_expr>
{
  ...
  static void info(LHS &lhs, RHS const &rhs)
  {
    ...
    dispatch_diagnostics<dispatcher::op::assign<D>, LHS &, RHS const &>(lhs, rhs);
  }
};
  ...
  static void info(LHS &lhs, RHS const &rhs)
  {
	...
	rhs_storage_type;
      ...
      dispatch_diagnostics<dispatcher::op::assign<D>,
	                   lhs_local_block_type &, rhs_local_block_type const &>
...
void assign_diagnostics(V<T, B> lhs_view, S scalar)
{
  ...
  V<S, expr::Scalar<B::dim, S> > scalar_view(block);
