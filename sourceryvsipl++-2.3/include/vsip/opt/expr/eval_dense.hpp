  ...
  void(LHS &, expr::Unary<OP, A, true> const &)>
{
  ...
  apply(op_type const &op,
	...
	length_type size)
  {
    typedef typename impl::Ext_data<LHS>::storage_type lhs_st;
    typedef typename impl::Ext_data<A>::storage_type a_st;
  ...
  static void exec(LHS &lhs, RHS const &rhs)
  {
    ...
    impl::Ext_data<LHS> ext_lhs(lhs);
    impl::Ext_data<A> ext_a(rhs.arg());
    apply(rhs.operation(),
	  ext_lhs.data(), ext_lhs.stride(lhs_minor),
	  ext_a.data(), ext_a.stride(a_minor),
	  ext_lhs.size());
  }
};
  ...
  void(LHS &, expr::Binary<OP, A1, A2, true> const &)>
{
  ...
  static bool const ct_valid = (!impl::Is_expr_block<LHS>::value &&
				...
				impl::Ext_data_cost<A1>::value == 0 &&
				!impl::Is_expr_block<A2>::value &&
				impl::Ext_data_cost<A2>::value == 0);
  ...
  {
    typedef typename impl::Ext_data<LHS>::storage_type lhs_st;
    typedef typename impl::Ext_data<A1>::storage_type a1_st;
    typedef typename impl::Ext_data<A2>::storage_type a2_st;
    for (index_type i = 0; i != size; ++i)
  ...
  static void exec(LHS &lhs, RHS const &rhs)
  {
    ...
    impl::Ext_data<LHS> ext_lhs(lhs);
    impl::Ext_data<A1> ext_a1(rhs.arg1());
    impl::Ext_data<A2> ext_a2(rhs.arg2());
    apply(rhs.operation(),
	  ext_lhs.data(), ext_lhs.stride(lhs_minor),
	  ext_a1.data(), ext_a1.stride(a1_minor),
	  ext_a2.data(), ext_a2.stride(a2_minor),
	  ext_lhs.size());
  }
};
  ...
  void(LHS &, expr::Ternary<OP, A1, A2, A3, true> const &)>
{
	...
	length_type size)
  {
    ...
    typedef typename impl::Ext_data<A1>::storage_type a1_st;
    typedef typename impl::Ext_data<A2>::storage_type a2_st;
    typedef typename impl::Ext_data<A3>::storage_type a3_st;
    for (index_type i = 0; i != size; ++i)
      lhs_st::put(lhs, i * lhs_stride,
		  op(a1_st::get(a1, i * a1_stride),
		     a2_st::get(a2, i * a2_stride),
  ...
  static void exec(LHS &lhs, RHS const &rhs)
  {
    ...
    impl::Ext_data<A1> ext_a1(rhs.arg1());
    impl::Ext_data<A2> ext_a2(rhs.arg2());
    impl::Ext_data<A3> ext_a3(rhs.arg3());
    apply(rhs.operation(),
	  ext_lhs.data(), ext_lhs.stride(lhs_minor),
	  ext_a1.data(), ext_a1.stride(a1_minor),
	  ext_a2.data(), ext_a2.stride(a2_minor),
	  ext_a3.data(), ext_a3.stride(a3_minor),
	  ext_lhs.size());
  }
};
