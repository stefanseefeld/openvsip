...
/** @file    benchmarks/prod.cpp
    ...
    @date    2005-10-11
    @brief   VSIPL++ Library: Benchmark for matrix-matrix products.
...
# endif
  ...
  case  103: loop(t_prod2pb<be::generic, float>()); break;
  case  104: loop(t_prod2pb<be::generic, complex<float> >()); break;
