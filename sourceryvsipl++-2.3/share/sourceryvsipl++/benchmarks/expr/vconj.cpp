...
/** @file    benchmarks/expr/vsq.cpp
    @author  Mike LeBlanc
    @date    2009-10-05
    @brief   VSIPL++ Library: Benchmark for vector conjugate
...
struct t_vconjugate1 : Benchmark_base
{
  ...
  void diag()
  {
    ...
    impl::assign_diagnostics(C, conj(A));
  }
};
...
#ifdef VSIP_IMPL_SOURCERY_VPP
  case  3: loop(t_vconjugate2<complex<float>, impl::Cmplx_inter_fmt>()); break;
  case  4: loop(t_vconjugate2<complex<float>, impl::Cmplx_split_fmt>()); break;
#endif
