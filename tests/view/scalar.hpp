...
template <typename T1,
	  ...
	  typename T3>
void
test_case(Op_holder<op_add>, T1 res, T2 a, T3 b)
{
...
template <typename T1,
	  ...
	  typename T3>
void
test_case(Op_holder<op_sub>, T1 res, T2 a, T3 b)
{
  typedef typename Value_type<T1>::type value_type;
...
template <typename T1,
	  ...
	  typename T3>
void
test_case(Op_holder<op_mul>, T1 res, T2 a, T3 b)
{
  typedef typename Value_type<T1>::type value_type;
...
template <typename T1,
	  ...
	  typename T3>
void
test_case(Op_holder<op_div>, T1 res, T2 a, T3 b)
{
  typedef typename Value_type<T1>::type value_type;
